...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(30 + 4000, new string[] { "잘했어!*^^*\n인테리어 소품을 만들 수 있는 부드러운 목재 5개를 선물로 줄게.",
                                               "(제작에 대해 설명)", "마을에 다양한 동물들이 있는 건 알고있지?", 
                                               "강아지에게 먹이를 주고 친해져봐!\n 널 따라다니면서 도움을 줄거야.", "강아지와 함께 로아를 찾아가봐"});
        talkData.Add(40 + 5000, new string[] { "반가워! OO아, 강아지랑 친해졌구나.", "물고기는 잡아봤어?", "낚시대가 없다면 부엉이한테 조합을 맡길 수 있어." });
        talkData.Add(40 + 5000, new string[] { "바다나 강가에서 물고기 5마리를 잡아봐" });
        talkData.Add(40 + 5000, new string[] { "고생했어~! 이제 말이랑 친해져봐" });
